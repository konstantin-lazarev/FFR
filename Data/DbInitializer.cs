...
namespace FamilyFinances.Data
{
    public class DbInitializer
    {
        public static void Initialize(FamilyFinancesContext context)
        {
            ...
            {
                new PurchaseCategory { Name = "Продукты" },
                new PurchaseCategory { Name = "Коммунальные" },
                new PurchaseCategory { Name = "Здоровье" },
                new PurchaseCategory { Name = "Заправки" },
                new PurchaseCategory { Name = "Дача" }
            };
            ...
            {
                new PaySource { Name = "ДК", FullName = "XXXX XXXX XXXX 0256", ValidThru="08/22" },
                new PaySource { Name = "КК" , FullName = "XXXX XXXX XXXX 3348", ValidThru="11/20" },
                new PaySource { Name = "Счет" , FullName = "Мастер счет в рублях" },
                new PaySource { Name = "Наличные" },
            };
